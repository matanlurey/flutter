...
/// `--local-engine` and `--local-engine-host` command line flags to the name of
/// the desired engine variants (e.g. "android_debug_unopt" and "host_debug_unopt").
/// Provided that the `flutter/` and `engine/` directories are located adjacent
/// to one another, the output folder will be located automatically.
///
