...
abstract class Artifacts {
  ...
  factory Artifacts.test({String? localEngine, String? localHostEngine, FileSystem? fileSystem}) {
    fileSystem ??= MemoryFileSystem.test();
    if (localEngine != null && localHostEngine != null) {
      return _TestLocalEngine(localEngine, localHostEngine, fileSystem);
    }
