...
final RegExp _kApplicationIdRegex =
    RegExp('^ApplicationId: (?<$_kApplicationIdRegexGroupName>.*)\$');
...
final RegExp _kAppLinkDomainsRegex =
    RegExp('^Domain: (?<$_kAppLinkDomainsGroupName>.*)\$');
...
class AndroidGradleBuilder implements AndroidBuilder {
  ...
  Future<void> buildGradleApp({
    ...
    if (localEngineInfo != null) {
      ...
      command
          .add('-Plocal-engine-host-out=${localEngineInfo.engineHostOutPath}');
      command.add(
