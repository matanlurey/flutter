...
public class MainActivity extends FlutterActivity {
  ...
  public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
    ...
    final MethodChannel channel = new MethodChannel(
        flutterEngine.getDartExecutor().getBinaryMessenger(), "texture");
  ...
  @Override
  public void
  onFlutterSurfaceViewCreated(@NonNull FlutterSurfaceView flutterSurfaceView) {
    flutterSurfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
      @Override
      public void surfaceCreated(SurfaceHolder holder) {
        final SurfaceTextureEntry textureEntry =
            flutterSurfaceView.getAttachedRenderer().createSurfaceTexture();
